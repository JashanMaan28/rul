...
const FLOAT_CARDS: FloatCard[] = [
  { color: "red", label: "+4", top: "14%", left: "22%", rot: -14, size: 1.1, dur: 14, delay: 0, depth: 1.0 },
  { color: "yellow", label: "7", top: "22%", left: "74%", rot: 18, size: 1.0, dur: 17, delay: 0.8, depth: 0.7 },
  { color: "blue", label: "↺", top: "62%", left: "26%", rot: 10, size: 0.9, dur: 13, delay: 1.4, depth: 0.8 },
  { color: "green", label: "+2", top: "66%", left: "72%", rot: -8, size: 1.15, dur: 16, delay: 0.3, depth: 1.1 },
  { color: "red", label: "⊘", top: "44%", left: "80%", rot: 22, size: 0.8, dur: 12, delay: 2.0, depth: 0.5 },
  { color: "yellow", label: "W", top: "78%", left: "48%", rot: -18, size: 0.95, dur: 15, delay: 1.1, depth: 0.9 },
  { color: "green", label: "3", top: "10%", left: "52%", rot: 6, size: 0.75, dur: 18, delay: 0.5, depth: 0.4 },
  { color: "blue", label: "+4", top: "40%", left: "18%", rot: -22, size: 0.85, dur: 14, delay: 1.7, depth: 0.6 },
];
